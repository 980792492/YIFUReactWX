...
export default class Test extends React.Component {
  ...
  fetchItems(isRefresh) {
    ...
    render() {
        ...
        return (
            <div>
                <div id="ListOutsite" style={{height: window.innerHeight, position: "relative"}}
                     onTouchStart={this.onTouchStart} onTouchEnd={this.onTouchEnd}>
                    <ul style={{listStyle: "none", margin: 0, padding: 0, minHeight: '150%'}}>
                        <p ref="PullDown" style={{
                          margin: 0,
                          height: '40px',
                          width: '100%',
                          textAlign: 'center',
                          ...
                          lineHeight: '40px'
                        }}>{this.pullDownTips[this.state.pullDownStatus]}</p>
                        {lis}
                        <p ref="PullUp" style={{
                          margin: 0,
                          height: '40px',
